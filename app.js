...
const getHeroes = () => [
    ...
    { name: "Angel", id: 16, set: "dark-city"},
    { name: "Bishop", id: 17, set: "dark-city"},
    { name: "Colossus", id: 18, set: "dark-city"},
    { name: "Daredevil", id: 19, set: "dark-city"},
    { name: "Domino", id: 20, set: "dark-city"},
